    ...
    <div className={style.page}>
      ...
      <div id="place" style={{ marginBottom: '60px' }}>
        ...
        <FaqContent title="現在の設置エリアを教えて欲しい">
          現在アイカサのサービスは関東、横浜、福岡、岡山にてサービスを導入しております。
        </FaqContent>
      ...
      <div id="payment" style={{ marginBottom: '60px' }}>
        ...
        <FaqContent title="支払いに問題が発生したらどうすればいい？">
          アプリより、アイカサお問い合わせ窓口にご連絡いただけますでしょうか？
        </FaqContent>
      ...
      <div id="others" style={{ marginBottom: '' }}>
        ...
        <FaqContent title="傘が壊れていました。">
          別の傘をレンタルすることは可能でしょうか？レンタル後、アイカサお問い合わせ窓口までご連絡いただけますでしょうか？ご利用の傘のレンタル履歴を修正させていただきます。
          <br />
          <br />
          新たに傘のレンタルが難しい場合、傘の根元にあるID番号と、ご利用いただいたスポットの名前をお問い合わせ窓口へご連絡いただけますでしょうか？
        </FaqContent>
        ...
        <FaqContent title="退会したい、利用停止したい。">
          退会につきまして、お問い合わせ窓口に『退会したい』とご連絡いただいてもよろしいでしょうか？
        </FaqContent>

        <FaqContent title="公式アプリが開けません。マップが正常に表示されません等">
          一度アプリを落としていただき、再度開いていただけませんでしょうか。
        </FaqContent>
        ...
        <FaqContent title="領収書作成できますか？">
          可能です。月末に作成いたしますので、お問い合わせ窓口まで、領収証作成希望とメッセージの上、宛名を教えていただけますでしょうか？
        </FaqContent>
        ...
        <FaqContent title="傘が盗まれた・盗難された">
          ...
          <br />
          などの状況をアイカサお問い合わせ窓口まで教えていただけますでしょうか？
        </FaqContent>
      </div>
    </div>
  </>
