export default props => (
  <svg width={128} height={128} viewBox="0 0 128 128" {...props}>
    <defs>
      ...
      />
      <path
        d="M24.556 7.222h-3.51C19.558 3.012 15.549 0 10.833 0 4.853 0 0 4.853 0 10.833s4.853 10.834 10.833 10.834h13.723a7.225 7.225 0 007.222-7.223 7.225 7.225 0 00-7.222-7.222z"
        id="prefix__a"
      />
      <path
        d="M13.722 0H0v14.444h13.722a7.225 7.225 0 007.222-7.222A7.225 7.225 0 0013.722 0z"
        id="prefix__d"
      />
      <path
      ...
      <g transform="translate(5.333 5.333)">
        ...
        <g transform="translate(72.778 33.889)">
          ...
          <g mask="url(#prefix__b)">
            ...
            />
            <path
              d="M31.778 14.531v-.087a7.225 7.225 0 00-7.222-7.222h-3.612v.18h3.612a7.224 7.224 0 017.222 7.13z"
              fillOpacity={0.2}
              fill="#FFF"
              fillRule="nonzero"
            />
            <path
              fill="url(#prefix__c)"
              fillRule="nonzero"
              d="M35.497 21.667H10.833l10.22-14.445z"
            />
            ...
            />
            <path
              d="M24.556 21.486H10.833C4.883 21.486.051 16.683 0 10.74v.087c0 5.98 4.853 10.833 10.833 10.833h13.723a7.225 7.225 0 007.222-7.222v-.086a7.226 7.226 0 01-7.222 7.135z"
              fillOpacity={0.1}
              fill="#212121"
              fillRule="nonzero"
            />
        ...
        <path
          fill="url(#prefix__h)"
          fillRule="nonzero"
          d="M58.667 48.667H37.333V27.333L58.667 14z"
        />
        <path
          d="M58.667 117.333a58.62 58.62 0 01-29.036-7.677l6.685-50.323h22.35v58z"
          fill="url(#prefix__i)"
          fillRule="nonzero"
        />
        <path
          fill="url(#prefix__j)"
          fillRule="nonzero"
          transform="matrix(-1 0 0 1 90.667 0)"
        ...
        <g transform="translate(14.333 46.333)">
          ...
          <g mask="url(#prefix__m)">
            ...
            />
            <path
              d="M36.667 16.767v-.1c0-4.6-3.734-8.334-8.334-8.334h-4.166v.209h4.166a8.335 8.335 0 018.334 8.225z"
              fillOpacity={0.2}
              fill="#FFF"
              fillRule="nonzero"
            />
            <path
              fill="url(#prefix__n)"
              fillRule="nonzero"
              d="M40.958 25H12.5L24.292 8.333z"
            />
        ...
        <path
          ...
          fill="url(#prefix__q)"
          fillRule="nonzero"
          transform="translate(14.333 46.333)"
        />
        <g fillRule="nonzero" opacity={0.1}>
          <path
